...
import org.jkiss.dbeaver.ext.cubrid.ui.editors.CubridUserHandler;
...
//        }
    ...
    private void buildBody(CubridPrivilage user, StringBuilder builder, Map<Object, Object> properties) {
        ...
        builder.append(password != null ?" COMMENT " + SQLUtils.quoteString(user, description.toString()):"");
    }
    ...
    public String getUserName(CubridPrivilage user, Map<Object, Object> properties) {
        Object name = properties.get(CubridUserHandler.NAME.getId());
        if(name != null) {
